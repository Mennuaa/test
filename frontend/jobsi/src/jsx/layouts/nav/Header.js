...
useEffect(() => {
    // Fetch the JSON file in the public directory
            ...
            <div className="media-body">
              <h6>
                {highlightNames(
                  ...
                  notification.hotel_name,
                  notification.room_name
                )}
              </h6>
              <small className="d-block">{notification.created_date}</small>
            </div>
          </div>
        </li>
      ))}
          	...
          	<div className="collapse navbar-collapse justify-content-between">
				<div className="header-left">
					<div className="input-group search-area">
						...
						<input type="text" className="form-control rounded-0" placeholder="Hledat" />
					</div>
				</div>
